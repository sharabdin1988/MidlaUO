...
namespace ClassicUO.MobileUI
{
    public static class MobileUiTranslation
    {
        ...
        private static readonly Dictionary<string, string> EnumValues = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["Combat"]                              = "Бой",
            ["Friends"]                             = "Друзья",
            ["Spell Grid"]                          = "Сетка заклинаний",
            ["SpellGrid"]                           = "Сетка заклинаний",
            ...
            // Заголовки блоков (Line.CreateRectangleArea)
            ["Filters"]                             = "Фильтры",
            ["Profiles"]                            = "Профили",
            ["Assistant Window Size"]               = "Размер окна ассистента",
            ["Open Doors"]                          = "Открытие дверей",
            ["Open Corpses"]                        = "Открытие трупов",
            ["Casting"]                             = "Каст заклинаний",
            ["Targeting"]                           = "Прицеливание",
            ["Dismount"]                            = "Верховая езда",
            ["Friends List"]                        = "Список друзей",
            ["Healing Options"]                     = "Параметры лечения",
            ["Controllable Elements"]               = "Доступные элементы",
            ["Hotkey"]                              = "Горячая клавиша",
            ["Macro Names"]                         = "Список макросов",
            ["Skills"]                              = "Навыки",
            ["Loot Items"]                          = "Предметы автолута",
            ["Dress Lists"]                         = "Списки экипировки",
            ["Dress Items"]                         = "Предметы экипировки",
            ["Organizer Lists"]                     = "Списки сортировки",
            ["Item"]                                = "Предмет",
            ["Graphic"]                             = "Графика (ID)",
            ["Hue"]                                 = "Цвет",
            ["Amount"]                              = "Количество",
            ["Lists"]                               = "Списки",
            ["Warning!"]                            = "Внимание!",
            ["Enter the New Profile Name"]          = "Введите имя нового профиля",
            ["Enter the New Macro Name"]            = "Введите имя нового макроса",
            ["Object Inspector"]                    = "Инспектор объектов",

            // Фильтры звуков, сообщений, стаффа
            ["Bard's Music"]                        = "Музыка бардов",
            ["Dog Sounds"]                          = "Лай собак",
            ["Cat Sounds"]                          = "Мяуканье кошек",
            ["Horse Sounds"]                        = "Ржание лошадей",
            ["Sheep Sounds"]                        = "Блеяние овец",
            ["Spirit Speak Sound"]                  = "Звук Spirit Speak",
            ["Fizzle Sound"]                        = "Звук срыва каста (Fizzle)",
            ["Backpack Sounds"]                     = "Звуки рюкзака",
            ["Deer Sounds"]                         = "Звуки оленей",
            ["Cyclop Titan Sounds"]                 = "Звуки циклопов/титанов",
            ["Bull Sounds"]                         = "Мычание быков",
            ["Dragon Sounds"]                       = "Звуки драконов",
            ["Chicken Sounds"]                      = "Кудахтанье кур",
            ["Emote Sounds"]                        = "Звуки эмоций",
            ["Death"]                               = "Экран смерти",
            ["Staff Items"]                         = "Невидимые предметы стаффа",
            ["Snooping Messages"]                   = "Сообщения обыска карманов",
            ["Trade Window"]                        = "Окно торговли",

            // Чекбоксы ассистента
            ["Load linked profile"]                 = "Загружать привязанный профиль",
            ["Use objects queue"]                   = "Очередь использования объектов",
            ["Always accept party invitations"]     = "Всегда принимать приглашения в группу",
            ["Display new corpses names"]           = "Показывать имена новых трупов",
            ["Count stealth steps"]                 = "Считать шаги в скрытности (Stealth)",
            ["Search new containers"]               = "Обыскивать новые контейнеры",
            ["Gauntlet bone cutter"]                = "Авто-резка костей (Bone cutter)",
            ["Show Bandage Timer:"]                 = "Таймер бинтов:",
            ["Show Bandage Timer: "]                = "Таймер бинтов: ",
            ["Start"]                               = "Старт",
            ["End"]                                 = "Конец",
            ["(Overhead)"]                          = "(Над головой)",
            ["Snap my own death"]                   = "Скриншот при своей смерти",
            ["Snap other players death"]            = "Скриншот при смерти других игроков",
            ["Use double click to open doors"]      = "Открывать двери двойным кликом",
            ["Clear hands before casting"]          = "Освобождать руки перед кастом",
            ["Highlight current target"]            = "Подсвечивать текущую цель",
            ["Limit target range to"]               = "Ограничить дальность цели до",
            ["Block heal if poisoned or yellow hits"] = "Блокировать лечение при яде/жёлтых HP",
            ["Use Target Queue"]                    = "Использовать очередь целей (Target Queue)",
            ["Automatically remount"]              = "Автоматически садиться на верхового",
            ["Prevent during warmode"]              = "Не садиться в боевом режиме",
            ["Check hands before potions"]          = "Проверять руки перед зельями",
            ["Health above people and creatures"]   = "Здоровье над персонажами и мобами",
            ["Flags above people and creatures"]    = "Флаги над персонажами и мобами",
            ["Include party members"]               = "Включать участников группы",
            ["Consider only this as valid friends"] = "Считать друзьями только этот список",
            ["Prevent attacking friends in warmode"] = "Запретить атаку друзей в бою",
            ["Scale priority based on hits"]        = "Приоритет лечения по уровню здоровья",
            ["Count seconds until finishes"]        = "Отсчёт секунд до завершения бинтов",
            ["Start below"]                         = "Начинать лечение ниже",
            ["Allow healing while hidden"]          = "Разрешить лечение в скрытности (Hide)",
            ["Use dexterity formula delay"]         = "Использовать формулу задержки от Dex",
            ["playmacro Returns to Parent"]         = "playmacro возвращает в родительский",
            ["Rec Type Use"]                        = "Запись по типу предмета (Type)",
            ["Loop"]                                = "Зациклить",
            ["No Interrupt"]                        = "Не прерывать",
            ["Disable inside guards zone"]          = "Отключать в зоне стражи",
            ["Move conflicting items"]              = "Перемещать конфликтующие предметы",
            ["Complete"]                            = "Завершено",
            ["Stack"]                               = "Объединять в стопку (Stack)",
            ["Pass to CUO"]                         = "Передавать в игру",

            // Кнопки действий ассистента
            ["New"]                                 = "Создать",
            ["Save"]                                = "Сохранить",
            ["Link"]                                = "Привязать",
            ["Apply"]                               = "Применить",
            ["Exemptions"]                          = "Исключения",
            ["Set Blade"]                           = "Выбрать клинок",
            ["Set Mount"]                           = "Выбрать маунта",
            ["Remove Friend"]                       = "Удалить друга",
            ["Insert Friend"]                       = "Добавить друга",
            ["Set Container"]                       = "Выбрать контейнер",
            ["Set Containers"]                      = "Выбрать контейнеры",
            ["Set Undress Container"]               = "Контейнер для раздевания",
            ["Remove Item"]                         = "Удалить предмет",
            ["Insert Item"]                         = "Добавить предмет",
            ["Dress"]                               = "Надеть",
            ["Undress"]                             = "Снять",
            ["Import"]                              = "Импорт надетых",
            ["New Item"]                            = "Новый предмет",
            ["Clear All"]                           = "Очистить всё",
            ["Use Serial"]                          = "По серийному ID",
            ["Use Type"]                            = "По типу предмета",
            ["Play"]                                = "Запуск",
            ["Stop"]                                = "Стоп",
            ["Record"]                              = "Запись",
            ["Add Button"]                          = "Создать кнопку",
            ["Clear"]                               = "Очистить",
            ["OKAY"]                                = "ОК",
            ["CANCEL"]                              = "ОТМЕНА",

            // Надписи и метки ассистента
            ["Opacity"]                             = "Прозрачность",
            ["Delay between Actions"]               = "Задержка между действиями (мс)",
            ["Limit open range to"]                 = "Открывать трупы в радиусе",
            ["tiles"]                               = "клеток",
            ["Share spell target on"]               = "Делиться целью заклинания",
            ["Smart last Target"]                   = "Умный выбор последней цели",
            ["Share enemy target on"]               = "Делиться вражеской целью",
            ["Bandage action delay"]                = "Задержка наложения бинтов",
            ["% hits"]                              = "% здоровья",
            ["Limit"]                               = "Лимит",
            ["DISABLED!"]                           = "ОТКЛЮЧЕНО!",
            ["Limit per sell:"]                     = "Лимит продажи:",
            ["Autoloot is Disabled"]                = "Автолут отключён",
            ["Changing to UOAssist!"]               = "Переключение на UOAssist!",
            ["Changing to Razor!"]                  = "Переключение на Razor!",
            ["Click on OKAY to close ClassicUO!"]   = "Нажмите ОК для перезапуска клиента!",
            ["Click on OKAY to overwrite it!"]      = "Нажмите ОК для перезаписи клавиши!",

            // Инспектор объектов (Object Inspector)
            ["Serial:"]                             = "Серийный номер:",
            ["Graphic:"]                            = "Графика (ID):",
            ["Color:"]                              = "Цвет:",
            ["Position (X Y Z):"]                   = "Координаты (X Y Z):",
            ["Mobile"]                              = "Существо / Игрок",
            ["Name:"]                               = "Имя:",
            ["Sex:"]                                = "Пол:",
            ["Hits:"]                               = "Здоровье:",
            ["Max Hits:"]                           = "Макс. здоровье:",
            ["Notoriety:"]                          = "Статус:",
            ...
            ["War Mode:"]                           = "Боевой режим:",
            ["Hidden:"]                             = "В скрытности:",
            ["Flying:"]                             = "В полёте:",
            ["Container:"]                          = "Контейнер:",
            ["Root Container:"]                     = "Корневой контейнер:",
            ["Amount:"]                             = "Количество:",
            ["Layer:"]                              = "Слой:",
            ["Owned:"]                              = "Принадлежит:",
            ["Female"]                              = "Женский",
            ...
            // Горячие клавиши (дерево категорий)
            ["Main"]                                = "Основные",
            ["Ping"]                                = "Пинг",
            ["Resyncronize"]                        = "Ресинхронизация",
            ["Toggle Hotkeys"]                      = "Вкл/Выкл горячие клавиши",
            ["Snapshot"]                            = "Скриншот",
            ["Actions"]                             = "Действия",
            ["Grab Item"]                           = "Взять предмет",
            ["Drop Current"]                        = "Бросить текущий",
            ["Toggle Mounted"]                      = "Сесть/Слезть с маунта",
            ["Use"]                                 = "Использовать",
            ...
            ["Corpses"]                             = "Трупы",
            ["Mobiles"]                             = "Существа и игроки",
            ["Creatures"]                           = "Питомцы и существа",
            ["Come"]                                = "Ко мне (Come)",
            ["Follow"]                              = "Следовать (Follow)",
            ["Guard"]                               = "Охранять (Guard)",
            ["Kill"]                                = "Атаковать (Kill)",
            ["Stay"]                                = "Стоять (Stay)",
            ["Stop"]                                = "Остановиться (Stop)",
            ["Buy"]                                 = "Покупка",
            ["Sell"]                                = "Продажа",
            ["Party"]                               = "Группа",
            ["Guild"]                               = "Гильдия",
