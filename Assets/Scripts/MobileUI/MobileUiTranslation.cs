...
namespace ClassicUO.MobileUI
{
    public static class MobileUiTranslation
    {
        ...
        private static readonly Dictionary<string, string> EnumValues = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["Display new corpses names"]           = "Имена новых трупов",
            ["Count stealth steps"]                 = "Шаги в скрытности (Stealth)",
            ["Search new containers"]               = "Обыск контейнеров",
            ["Gauntlet bone cutter"]                = "Резка костей",
            ["Show Bandage Timer:"]                 = "Таймер бинта:",
            ["Show Bandage Timer: "]                = "Таймер бинта: ",
            ["Start"]                               = "Старт",
            ["End"]                                 = "Конец",
            ["(Overhead)"]                          = "(Экран)",
            ["Snap my own death"]                   = "Скриншот своей смерти",
            ["Snap other players death"]            = "Скриншот чужой смерти",
            ["Use double click to open doors"]      = "Двери 2-кликом",
            ["Clear hands before casting"]          = "Руки перед кастом",
            ["Highlight current target"]            = "Подсветка текущей цели",
            ["Limit target range to"]               = "Дальность цели до",
            ["Block heal if poisoned or yellow hits"] = "Блок хила: яд/жёлтые HP",
            ["Use Target Queue"]                    = "Очередь целей",
            ["Automatically remount"]              = "Авто-маунт",
            ["Prevent during warmode"]              = "Не садиться в War",
            ["Check hands before potions"]          = "Руки перед зельями",
            ["Health above people and creatures"]   = "HP над существами",
            ["Flags above people and creatures"]    = "Флаги над существами",
            ["Include party members"]               = "Включать группу",
            ["Consider only this as valid friends"] = "Друзья только из списка",
            ["Prevent attacking friends in warmode"] = "Не бить друзей в War",
            ["Scale priority based on hits"]        = "Приоритет по % HP",
            ["Count seconds until finishes"]        = "Отсчёт времени бинтов",
            ["Start below"]                         = "Лечить ниже",
            ["Allow healing while hidden"]          = "Хил в скрытности (Hide)",
            ["Use dexterity formula delay"]         = "Задержка от Dex",
            ["playmacro Returns to Parent"]         = "playmacro в родительский",
            ["Rec Type Use"]                        = "Запись по типу (Type)",
            ["Loop"]                                = "Зациклить",
            ["No Interrupt"]                        = "Не прерывать",
            ["Disable inside guards zone"]          = "Отключать в Guard-зоне",
            ["Move conflicting items"]              = "Смещать конфликтные вещи",
            ["Complete"]                            = "Завершено",
            ["Stack"]                               = "Объединять в стопку",
            ...
            ["Delay between Actions"]               = "Пауза действий (мс)",
            ["Limit open range to"]                 = "Радиус трупов",
            ["tiles"]                               = "кл.",
            ["Share spell target on"]               = "Цель заклинания",
            ["Smart last Target"]                   = "Умная цель",
            ["Share enemy target on"]               = "Цель врага",
            ["Bandage action delay"]                = "Задержка бинтов",
            ["% hits"]                              = "% HP",
            ["Limit"]                               = "Лимит",
            ["DISABLED!"]                           = "ОТКЛЮЧЕНО!",
