...
* **Авто-сортировка `[ ⚡ Сорт ]`**: в один клик раскладывает содержимое сумки по категориям:
  ...
  5. Зелья и бинты
  6. Спеллбуки (книги спеллов), рунбуки, руны и свитки
  7. Реагенты
...
### 📖 2. Сенсорный спеллбук (Spellbook) и Книга рун (Runebook)
* **Крупные кнопки**: фильтры по кругам спеллов (Круги 1–8), вкладка «✈ Быстрые спеллы» (Recall, Gate, Greater Heal, Cure, Bless...) и общий список.
* **Вынос спеллов на игровой экран (HUD)**:
  * Кнопка `[ + Экран ]` или простое перетаскивание иконки спелла пальцем прямо на игровое поле.
...
* **Магнитная стыковка (Anchorable Buttons)**: кнопки спеллов, рун, навыков и макросов автоматически «магнитятся» друг к другу, образуя аккуратную компактную панель быстрого доступа у края экрана.
